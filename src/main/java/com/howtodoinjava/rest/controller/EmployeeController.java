...
// Os dados do objeto são gravados diretamente na resposta HTTP como JSON ou XML
// para cliente processá-los

// EXECUTAR A APLICAÇÃO - POSTMAN ou CHROME Advanced REST Client
// GET --> http://localhost:8080/employees/
// POST --> http://localhost:8080/employees/
// > header : Content-Type application/json
// > adicionar na body (RAW) (JSON) : {"firstName": "Xxxx", "lastName": "Yyyyy",
