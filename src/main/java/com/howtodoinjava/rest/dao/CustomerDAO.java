...
public class CustomerDAO 
{
    ...
    public static Telefone t2 = new Telefone(1,"21","978658897");
    ...
    
    {
        ...
        list.getCustomerList().add(new Customer(3, "Michael", "null", "53691236823", "michael@andrettiracing.com", "23", "987451614"));
    }
